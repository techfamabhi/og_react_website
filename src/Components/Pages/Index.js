										...
										<div class="row">
													...
													<div class="product-img">
														...
														<div class="button-head">
															<div class="product-action">
																...
																<a title="Wishlist" href="/wishlist"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
																<a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
															</div>
															<div class="product-action-2">
																<a add to carttitle="See All Product" href="/shop">See All Product</a>
															</div>
														</div>
													</div>
													<div class="product-content">
														<h3><a href="product-details.#">Men Collection</a></h3>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.#">Awesome Tshirt </a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.#">Awesome New Tshirt</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.#">Awesome Oversize tshirt </a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
										...
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.#">women t shirt Collection</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
									...
									<div class="tab-single">
										...
										<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.#">Laptop Collection</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
										...
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.#">Mobile Collection</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
										...
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.#">Watch Collection</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
												...
												<div class="single-product">
													<div class="product-img">
														<a  href={'/description/' + row.id}>
															<img class="default-img" src={`http://localhost:8000/product_upload/${row.img}`} alt="#"  style={{width:"100%",height:"210px"}} />
															{/* <img class="hover-img" src="https://via.placeholder.com/550x750" alt="#"/> */}
														</a>
														<div class="button-head">
                            <div class="product-action">
																<a title="Quick View" 
                                href={'/description/' + row.id}><i class=" ti-eye"></i><span>Quick Shop</span></a>
																<a title="Wishlist" href="/wishlist"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
																<a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
															</div>
															<div class="product-action-2">
																<a title="See All Product"  href={'/description/' + row.id}>Add To Cart</a>
															</div>
														</div>
													</div>
													<div class="product-content">
														<h3><a  href={'/description/' + row.id}>{row.pname}</a></h3>
														<div class="product-price">
															<span><i class="fa fa-rupee"></i> {row.price_sale}</span>
														</div>
													</div>
												</div>
											</div>
